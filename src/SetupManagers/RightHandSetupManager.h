...
#ifndef RightHandSetupManager_H
#define RightHandSetupManager_H

#include "SetupManagerBase.h"
#include "../SharedConstants.h"

class RightHandSetupManager : public SetupManagerBase
{
public:
  RightHandSetupManager();
