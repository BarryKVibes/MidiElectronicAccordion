/*******************************************************************************
  BellowsVolumeSensorChangedHandler.h
...
#ifndef BellowsVolumeSensorChangedHandler_H
#define BellowsVolumeSensorChangedHandler_H
...
class BellowsVolumeSensorChangedHandler : public SensorChangedHandlerBase
{
public:
  BellowsVolumeSensorChangedHandler();
