...
#ifndef BassButtonChangedHandler_H
#define BassButtonChangedHandler_H
...
class BassButtonChangedHandler : public NoteButtonChangedHandler
{  
public:
  BassButtonChangedHandler();
