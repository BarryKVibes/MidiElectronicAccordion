...
#ifndef ToneButtonChangedHandler_H
#define ToneButtonChangedHandler_H
...
class ToneButtonChangedHandler : public ButtonChangedHandlerBase
{
public:
  ToneButtonChangedHandler();
