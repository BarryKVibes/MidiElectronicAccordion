/*******************************************************************************
  ChordButtonChangedHandlerndler.h
...
#ifndef ChordButtonChangedHandler_H
#define ChordButtonChangedHandler_H
...
class ChordButtonChangedHandler : public NoteButtonChangedHandler
{
public:
  ChordButtonChangedHandler();
